...
const getAnimalEnglishKey = (animal: any): string => {
  ...
  const nameToKeyMap: { [key: string]: string } = {
    ...
    'ganso': 'goose', 'caballo': 'horse', 'cerdo': 'pig',
    ...
    'rana': 'frog', 'cocodrilo': 'crocodile', 'serpiente': 'snake',
    'oso hormiguero': 'ant eater', 'elefante asiático': 'asian elephant',
    ...
    'cão': 'dog', 'cachorro': 'dog', 'gata': 'cat', 'galinha': 'chicken', 'pintinho': 'chick',
    'jumento': 'donkey', 'pata': 'duck', 'bode': 'goat',
    'cavalo': 'horse', 'lhama': 'llama', 'porco': 'pig',
    'coelho': 'rabbit', 'ovelha': 'sheep', 'peru': 'turkey',
    'urso polar': 'white bear', 'raposa ártica': 'white fox',
    'rena': 'reindeer', 'coruja-das-neves': 'snow owl',
    'pinguim': 'penguin',
    'texugo': 'badger', 'raposa': 'fox', 'urso': 'bear', 'guaxinim': 'raccoon',
    'esquilo': 'squirrel', 'ouriço': 'hedgehog', 'coruja': 'owl', 'veado': 'deer',
    'alce': 'moose', 'rato': 'mouse', 'javali': 'boar', 'morcego': 'bat',
    'lontra': 'otter', 'gambá': 'skunk',
    ...
    'cavalo-marinho': 'seahorse', 'tubarão': 'shark', 'camarão': 'shrimp',
    'estrela do mar': 'starfish', 'arraia': 'stingray', 'baleia': 'whale',
    'camelo': 'camel', 'tartaruga do deserto': 'desert tortoise', 'feneco': 'fennec fox',
    'iguana': 'iguana', 'gerbo': 'jerboa',
    'suricate': 'meerkat', 'gato-do-deserto': 'sand cat',
    'escorpião': 'scorpion', 'lagarto': 'lizard',
    'formiga': 'ant', 'abelha': 'bee', 'borboleta': 'butterfly', 'besouro': 'beetle',
    'lagarta': 'caterpillar', 'barata': 'cockroach', 'libélula': 'dragonfly',
    'vagalume': 'firefly', 'gafanhoto': 'grasshopper',
    'joaninha': 'ladybug', 'louva-a-deus': 'mantis',
    'lesma': 'snail', 'aranha': 'spider', 'minhoca': 'worm', 'vespa': 'wasp',
    'grilo': 'cricket',
    'girafa': 'giraffe', 'leão': 'lion',
    'rinoceronte': 'rhinoceros', 'hipopótamo': 'hippopotamus', 'chita': 'cheetah',
    'antelope': 'antelope', 'bisão': 'bison',
    'macaco': 'monkey', 'javali selvagem': 'wild boar',
    'onça-pintada': 'jaguar',
    'chimpanzé': 'chimpanzee',
    'bicho-preguiça': 'sloth',
    'sapo': 'frog', 'crocodilo': 'crocodile', 'tamanduá': 'ant eater',
    'elefante asiático': 'asian elephant', 'tigre de bengala': 'bengal tiger',
    'naja': 'cobra',
    'pomba': 'dove',
    'avestruz': 'ostrich', 'papagaio': 'parrot',
    'corvo': 'raven',
    'pardal': 'sparrow', 'cegonha': 'stork',
    'pica-pau': 'woodpecker', 'pavão': 'peacock',
